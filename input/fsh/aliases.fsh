...
Alias: $library-type = http://terminology.hl7.org/CodeSystem/library-type // http://hl7.org/fhir/ValueSet/library-type
...
// Base
Alias: $base = https://path-global-health.github.io/MERindicators
